...
export class UserService {
  ...
  users: User[] = [
    {id:1, name: 'Aleix Diaz Sancho', email:'aleix@gmail.com', password: '1234',role: 'usuario', ubicacion: 'Lerida', telefono: 623426379, fotoPerfil: 'localhost:8000/storage/Images/userProfPic/aleix.jpg'},
