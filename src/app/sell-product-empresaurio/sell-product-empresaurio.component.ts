...
import { SellProductPictureEmpresaurioComponent } from "../sell-product-picture-empresaurio/sell-product-picture-empresaurio.component"; // Recuperamos el id del producto desde la URL para editarlo y poder actualizarlo


@Component({
  selector: 'app-sell-product-empresaurio',
  standalone: true,
  imports: [SellProductPictureEmpresaurioComponent,FormsModule,ReactiveFormsModule,
    NavBeltComponent,
    NavCategoriesComponent,
    RouterModule],
  templateUrl: './sell-product-empresaurio.component.html',
  styleUrl: './sell-product-empresaurio.component.css'
})
export class SellProductEmpresaurioComponent {
