...
@Component({
  selector: 'app-sell-product-picture-empresaurio',
  standalone: true,
  imports: [],
  templateUrl: './sell-product-picture-empresaurio.component.html',
  styleUrl: './sell-product-picture-empresaurio.component.css'
})
export class SellProductPictureEmpresaurioComponent {
